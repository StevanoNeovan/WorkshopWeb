...
<div class="page-header">
  <h3 class="page-title">
    ...
    </span> Tambah Customer 1
    <span class="badge badge-gradient-warning ms-2" style="font-size:.7rem">Foto disimpan sebagai BLOB</span>
  </h3>
  ...
  <div class="col-lg-7 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('customer.tambah1.store') }}" id="formCustomer">
          @csrf
          {{-- Hidden input untuk foto base64 --}}
          <input type="hidden" name="foto_blob" id="fotoInput">
